...
(defvar my/install-packages
  '(
    ...
    apropospriate-theme material-theme smart-mode-line
    ...
    vlf hydra shrink-whitespace ix quick-preview pdf-tools
...
Another var that will be checked at the end

#+BEGIN_SRC emacs-lisp
(defvar my/enable-desktop-save t
  "Var to tell my config whether to enable desktop save mode")
#+END_SRC
...
(defun start-rcirc ()
  (interactive)
  ;; Disable desktop save mode for the "IRC" emacs
  (setq my/enable-desktop-save nil)
  (load-file "~/.ercpass")
  (use-package rcirc
    :init
    (progn
...
(defun mail ()
  (interactive)
  ;; Disable desktop save mode for the "email" emacs
  (setq my/enable-desktop-save nil)
...
Save the desktop by default (will be turned off for IRC and email Emacs flavors

#+BEGIN_SRC emacs-lisp
(when my/enable-desktop-save
  (desktop-save-mode 1))
#+END_SRC
