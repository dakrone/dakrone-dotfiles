...
(defun my/setup-semantic-mode ()
  ...
  (use-package semantic
    :init
    (progn
      (load "~/src/elisp/cedet/lisp/cedet/loaddefs.el")
      (load "~/src/elisp/cedet/lisp/cedet/semantic/loaddefs.el")))
  (require 'semantic/ia)
...
(use-package prodigy
  ...
  (progn
    (prodigy-define-service
      :name "Elasticsearch 1.4.1"
      :cwd "~/ies/elasticsearch-1.4.1/"
      :command "~/ies/elasticsearch-1.4.1/bin/elasticsearch"
      :tags '(work test es)
      :port 9200)
