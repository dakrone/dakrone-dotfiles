...
(defun my/dired-linux-open ()
  "Use the Linux `xdg-open' command to open a file with the correct editor"
  (interactive)
  (save-window-excursion
    (dired-do-async-shell-command
...
(defun my/setup-x11-fonts ()
  (when (eq window-system 'x)
    ...
    ;; (set-fontset-font "fontset-default" 'symbol "DejaVu Sans Mono")
...
(define-key my/toggle-map "g" 'golden-ratio-mode)
...
(define-key my/toggle-map "h" 'hl-line-mode)
(define-key my/toggle-map "v" #'my/turn-on-viewing-mode)
