...
well as the general theme for things.
...
(defun mail ()
  ...
  (add-to-list 'load-path "~/src/mu-0.9.15/mu4e")
...
I use EWW as my default browser in Emacs; certain things, I need to jump out of EWW and in to a real
browser with javascript; which I can do if I just hit =&= -- it'll drop me in to a firefox session
without a hassle.
