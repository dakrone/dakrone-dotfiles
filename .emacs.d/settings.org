...
(defvar my/install-packages
  '(
    ...
    color-identifiers-mode moe-theme powerline nyan-mode zenburn-theme
    flatui-theme tangotango-theme smyx-theme monokai-theme
...
(use-package org
  ...
  (progn
    ...
    (setq org-clock-history-length 23
          ...
          '(:maxlevel 10 :fileskip0 t :score agenda :block thismonth :compact t :narrow 80))))
#+END_SRC
  ...
  (use-package mu4e
    ...
    (progn
      ...
      (setq mu4e-mu-binary "/usr/local/bin/mu"
            ...
            '("matthew.hinman@gmail.com" "lee@writequit.org"
              "lee.hinman@elasticsearch.com")
...
(use-package prodigy
  ...
  (progn
    (prodigy-define-service
      ...
      :cwd "~/ies/elasticsearch-1.4.3/"
      :command "~/ies/elasticsearch-1.4.3/bin/elasticsearch"
      :tags '(work test es)
      :port 9200)
...
** hydra
Hydra is the new package on the block, and a lot of people seem to like it. It
seems like a toggle-map for Emacs, so I'm going to use it for org-mode related
bindings and clocking and all that.

#+BEGIN_SRC emacs-lisp
(use-package hydra
  :init
  (progn
    (defhydra hydra-org-clock (global-map "C-x C-o")
      "clock-actions"
      ("i" my/org-clock-in "clock in")
      ("o" org-clock-out "clock out")
      ("g" org-clock-jump-to-current-clock "go to current clock")
      ("q" nil "cancel"))))
#+END_SRC
