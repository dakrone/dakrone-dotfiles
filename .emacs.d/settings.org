...
(defun dakrone-dark ()
  ...
  ;;   :init (moe-dark)
  ;;   :config
  ;;   ;; Moe's string color is a bit too... magenta
  ;;   (set-face-foreground 'font-lock-string-face "#ff7bbb")
  ;;   )
)
  ...
  (setq org-publish-project-alist
        ...
        '(("emacs dotfiles"
          ...
          ("org-images"
           ...
           :publishing-directory "/ssh:hinmanph@writequit:~/public_html/wq/paste/org/images"
          ...
          ("org-es-images"
           ...
           :publishing-directory "/ssh:hinmanph@writequit:~/public_html/wq/paste/org/images"
           :publishing-function org-publish-attachment)
          ("org-es" :components ("org-es-org" "org-es-images"))
