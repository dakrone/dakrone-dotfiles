  ...
  (progn
    ...
    (use-package esh-opt
      ...
      (progn
        ...
        (defun eshell/l (&rest args) "Same as `ls -lh'" (apply #'eshell/ls "-lh" args))
        (defun eshell/ll (&rest args) "Same as `ls -lh'" (apply #'eshell/ls "-lh" args))
        (defun eshell/la (&rest args) "Same as `ls -alh'" (apply #'eshell/ls "-alh" args))
...
** org-mode
:PROPERTIES:
:ID:       47917AC7-93A4-4A8F-B45C-0F482904778C
:END:
...
(use-package ediff
  ...
  (progn
    (setq
     ;; Don't use a separate frame for a control
