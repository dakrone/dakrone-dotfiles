...
(defvar my/install-packages
  '(
    ...
    ggtags bookmark+ golden-ratio wc-mode eyebrowse vlf hydra shrink-whitespace
    ix quick-preview pdf-tools smartscan indent-guide ws-butler
