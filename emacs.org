...
(defvar my/install-packages
  '(
    ...
    moe-theme nyan-mode color-theme-sanityinc-tomorrow
    apropospriate-theme material-theme smart-mode-line beacon
    ...
    simple-call-tree+ ggtags bookmark+ golden-ratio wc-mode eyebrowse
    vlf hydra shrink-whitespace ix quick-preview pdf-tools origami
    smartscan
    ...
    ;; logs
    log4j-mode logview logstash-conf
    ...
    helm-gtags helm-ls-git helm-flycheck helm-flyspell helm-dash helm-flx
...
(use-package org
  ...
  (progn
    ...
    (custom-set-variables '(org-export-backends '(ascii html latex beamer md odt)))
...
(use-package projectile
  :defer t
  :bind (("C-c p b" . projectile-switch-to-buffer)
...
** logview
I'm testing out =[[https://github.com/doublep/logview][logview]]= as an alternative to log4j-mode, since it supposedly
supports more modes and seems more updated
...
** origami
Origami is another folding method, but a bit different than hideshow.
...
(use-package origami
  ...
  (progn
    ...
    (define-key origami-mode-map (kbd "<C-M-return>") 'origami-toggle-all-nodes)
...
(use-package smartscan
  ...
  :config
  (define-key smartscan-map (kbd "M-'") #'other-window))
#+END_SRC
