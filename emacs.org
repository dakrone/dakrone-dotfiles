...
(defvar my/install-packages
  '(
    ...
    ix quick-preview pdf-tools smartscan indent-guide fill-column-indicator
...
#+BEGIN_SRC emacs-lisp
(setq-default whitespace-line-column nil) ;; use fill-column instead
...
(use-package markdown-mode
  ...
  :init (add-hook 'markdown-mode-hook #'whitespace-mode-hook)
