...
**** jdee
So since JDEE was restarted, I figured I'd give it a try for the ol' emacs
configuration.

#+BEGIN_SRC emacs-lisp
(when (file-exists-p "~/src/elisp/jdee/dist/jdee-2.4.2/lisp")
  (add-to-list 'load-path "~/src/elisp/jdee/dist/jdee-2.4.2/lisp")
  (load "jde-autoload"))
#+END_SRC
